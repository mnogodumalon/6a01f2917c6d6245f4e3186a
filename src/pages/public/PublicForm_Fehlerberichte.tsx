...
const PROXY_BASE = '';
const APP_ID = '6a01f27386a0e488786a9877';
...
export default function PublicFormFehlerberichte() {
    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-lg">
        <div className="text-center mb-8">
          <h1 className="text-2xl font-bold text-foreground">Fehlerberichte — Formular</h1>
        </div>
